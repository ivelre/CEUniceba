...
// Route::get('/test/{plan_especialidad_id}','Admin\Academicos\KardexController@getReticulaPlan');
...
Route::group(['middleware' => ['login']], function () {
	...
	Route::prefix('admin')->group(function () {
		//Caja
		Route::get('/importar', 'Admin\Caja\cajaController@importar') -> name('importar');
		Route::get('/caja', 'Admin\Caja\cajaController@index') -> name('caja');
		Route::get('/caja/reportes', 'Admin\Caja\cajaController@reportes') -> name('reportesCaja');

		Route::get('/get/estudiantes','Admin\Caja\cajaController@getEstudiantes') -> name('getEstudiantes');
		Route::post('/set/pagos/estudiante','Admin\Caja\cajaController@setPagoEstudiante') -> name('nuevoPago');
		Route::post('/set/pagos/estudiantes','Admin\Caja\cajaController@setPagosEstudiantes')->name('nuevosPagos');
		Route::delete('/delete/pago/estudiante/{pago_id}','Admin\Caja\cajaController@deletePagoEstudiante')->name('deletePago');

		Route::get('/get/pagos/estudiantes/{page}/{busueda}','Admin\Caja\cajaController@getPagosEstudiantes')->name('getPagosEstudiantes');
		Route::get('/get/pagos/estudiante/{estudiantes_id}','Admin\Caja\cajaController@getPagosEstudiante');
		// Route::post('/set/pagos/estudiante','Admin\Caja\cajaController@setPagoEstudiante');
		Route::post('/set/archivo','Admin\Caja\cajaController@setArchivo');
		...
		// Menu Principal
			...
			Route::prefix('academicos')->group(function () {
				...
				// Estudiantes
				Route::get('estudiantes/{estudiante_id}/pagos','Admin\Academicos\EstudianteController@getPagosEstudiante')->name('estudiante.pago');
				...
				Route::post('kardex/cambiar/estado/estudiante','Admin\Academicos\KardexController@cambiarEstadoEstudiante')->name('kardex.cambiar.estado.estudiante');
			...
			Route::prefix('pdf')->group(function() {
				...
				*/
				...
				Route::get('/grupo/lista/{meses}', 'Admin\PDFListaGrupoController@lista')->name('pdf.grupo.lista');
				...
				Route::get('/caja/reportes/ingresos/{tipo_reporte}/{especialidad}/{fecha_inicio}/{fecha_final}', 'Admin\PDFCajaController@ingresos')->name('pdf.reportes.ingresos');
				Route::get('/caja/reportes/poliza/{banco_i}/{fecha_inicio}/{fecha_final}', 'Admin\PDFCajaController@poliza')->name('pdf.reportes.poliza');
			});
