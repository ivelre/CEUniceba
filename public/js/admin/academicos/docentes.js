! function(e) {
	...
	function a() {
		var e = $("#table_docentes").DataTable({
			language: {
		...
		$("select[name$='table_docentes_length']").val("10"), $("select[name$='table_docentes_length']").material_select(),
			function(e, t) {
				$(e).on("click", "a.delete-docente", function() {
					var e = t.row($(this).parents("tr")).data();
					swal({
						...
						t.value && (docente_id = e.docente_id, function(e) {
							$.ajax({
								url: public_path + "admin/academicos/docentes/" + e,
								type: "DELETE",
								success: function(e) {
									a(), swal({
										type: "success",
